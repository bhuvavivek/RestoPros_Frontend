...
export const paths = {
  ...
  dashboard: {
    ...
    foodItem: `${ROOTS.DASHBOARD}/food-item`,
    ...
    userpermission: {
      root: `${ROOTS.DASHBOARD}/user-permission`,
      new: `${ROOTS.DASHBOARD}/user-permission/new`,
      edit: (id) => `${ROOTS.DASHBOARD}/user-permission/${id}/edit`,
    },
    saleorder: `${ROOTS.DASHBOARD}/sale-orders`,
    general: {
    ...
    order: {
      ...
      edit: (id) => `${ROOTS.DASHBOARD}/edit-order/${id}`,
      demo: {
